...
const Nav = () => {
	...
	return (
		<nav className="flex flex-col items-center xl:justify-center gap-y-4 translate-y-0 fixed bottom-0 mt-auto xl:right-[2%] z-40 w-full xl:w-16 xl:max-w-md xl:h-screen">
			{/* inner */}
						...
						>
							...
							<div className="absolute pr-14 right-0 hidden xl:group-hover:flex">
								<div className="bg-white relative flex text-primary items-center p-[6px] rounded-[3px]">
									...
									{/* triangle */}
									<div className="border-solid border-l-white border-l-[5px] border-y-transparent border-y-[6px] border-r-0 absolute -right-[0.3rem]"></div>
								</div>
							</div>
